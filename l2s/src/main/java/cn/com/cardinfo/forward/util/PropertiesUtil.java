...
public class PropertiesUtil {
	...
	private static String propertiesPath = System.getProperty("user.home")+"/.cardinfo/l2s.properties";
	private static String backpropertiesPath = "./l2s.properties";
	...
	public static String getHubMode(){
		return PropertiesUtil.getInstance().getConfig("hub.mode");
	}
