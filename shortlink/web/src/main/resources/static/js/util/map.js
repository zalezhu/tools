define(['amplify'], function () {
    ...
    function baidu_map(data) {
        ...
        amplify.forcedUnsubscribe('map.address.change');
        amplify.forcedUnsubscribe('map.point.change');
        amplify.forcedUnsubscribe('map.disable.dragging');
        amplify.forcedUnsubscribe('map.config.needLocation');
